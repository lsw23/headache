	...
	<c:import url="../module/top.jsp"/>
			...
			<div class="templatemo-content-container row col-md-12">
				<div class="templatemo-content-widget white-bg" style="min-height: 650px;">
					...
					<hr>
					<!-- main start -->
					<form class="templatemo-login-form" action="${pageContext.request.contextPath}/branch_owner_modify_pro" method="post">
						...
						<div class="form-group text-right">
							<a href="${pageContext.request.contextPath}/barach_owner/branch_owner_list">
								<input type="button" class="templatemo-white-button" value="back"/>
							</a>
							<button type="submit" class="templatemo-blue-button">Modify</button>
							<a href="${pageContext.request.contextPath}/branch_owner_delete_pro?branch_owner_cd=${info.branch_owner_cd}">
