...
-->
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/test/css/bootstrap.min.css">                                                <!-- Bootstrap style -->
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/test/css/flexslider.css">                                                   <!-- Flexslider style -->       
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/test/css/templatemo-style.css">                                             <!-- Templatemo style -->
...
<body class="page">     
	...
	<div class="page-bg-imgs-list">
	    <img src="${pageContext.request.contextPath}/resources/test/img/main4.jpg" id="page-1-img" class="main-img" alt="About">
		...
		<img src="${pageContext.request.contextPath}/resources/test/img/main4.jpg" id="page-4-img" alt="Contact">                            
	</div>
	            ...
	            <div class="header">
					...
					<header class="box box-white">
					    <a href="javascript:void(0)" class="js-site-title">
					        <h1 class="box-text site-title-text">ing...</h1>
					    </a>            
					</header>
